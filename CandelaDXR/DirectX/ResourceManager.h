...
namespace candela::directx
{
	...
	public:
		...
		Resource& createResourceIfNotExists(D3D12_RESOURCE_STATES resourceState, D3D12_RESOURCE_FLAGS resourceFlags, UINT width, UINT height, DXGI_FORMAT format, bool resizeOnResize, std::string globalName, D3D12_HEAP_TYPE heapType = D3D12_HEAP_TYPE_DEFAULT, D3D12_CLEAR_VALUE* clearValue = nullptr);
		...
		bool namedResourceExists(const std::string& resourceName) const;
